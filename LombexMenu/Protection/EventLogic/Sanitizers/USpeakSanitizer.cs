...
namespace Protection.EventLogic.Sanitizers
{
    internal class USpeakSanitizer : ISanitizer
    {
        ...
        public USpeakSanitizer()
        {
            ...
            {
                if (!x.Name.StartsWith("Method_Public_Int32_ArrayOf_Byte_Int32_") || x.Name.Contains("_PDM_")) return false;
        ...
        {
            if (_rateLimiter.IsRateLimited(eventData.Sender)) return true;
            ...
            while (sourceOffset < source.Length)
            {
                ...
                // container.Method_Public_Void_0(); Check later
                sourceOffset += offset;
            }
